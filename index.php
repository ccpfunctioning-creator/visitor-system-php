    ...
    <div class="form-card-container mx-auto animate-fade-in" style="max-width: 850px;">
        <form action="index.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="d-flex justify-content-end gap-2 mt-4 pt-3 border-top">
                ...
                <button type="submit" id="submitBtn" class="btn text-white px-4 py-2 fw-bold rounded-3 shadow" style="background: linear-gradient(135deg, #4f46e5 0%, #7c3aed 100%); border: none;">
